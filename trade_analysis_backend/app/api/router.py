...
from app.api.routes.future_fundamental_analyses import router as future_fundamental_analysis_router
from app.api.routes.future_products import router as future_product_router
from app.api.routes.future_report_documents import router as future_report_document_router
...
api_router.include_router(
    future_product_router,
    prefix="/future-products",
    tags=["future-products"],
)
api_router.include_router(
    future_report_document_router,
    prefix="/future-report-documents",
    tags=["future-report-documents"],
)
api_router.include_router(
    future_fundamental_analysis_router,
    prefix="/future-fundamental-analyses",
    tags=["future-fundamental-analyses"],
)
